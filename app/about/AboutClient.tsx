...
export default function AboutClient() {
  return (
    <div className="min-h-screen bg-white">
      <BreadcrumbSchema
        items={[
          { name: "Home", url: "https://kevalmarketing.com" },
          { name: "About Us", url: "https://kevalmarketing.com/about" },
        ]}
      />
      <Navbar />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <img
                ...
                alt="Keval Marketing storefront at Sitaram Complex, Subhanpura, Vadodara"
      ...
      {/* Mission & Vision - Gray Background */}
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
